...
## Project summary
An AI-powered knowledge base assistant that answers internal company questions using documentation, SOPs, and knowledge articles.
Moreover, the project focuses on mitigating effects of climate change by use of IBM technologies such as Watsonx and Cognos analytics
The system:
...
Embeds them into Qdrant vector database
